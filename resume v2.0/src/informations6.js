...
const projets = {
  ...
  "Modelisation et simulation d'une fonction ADAS: CC .":
    [
      'Matlab / Simulink / Stateflow',
      'Cruise Control',
    ],
  "Conception d'un microprocesseur 16-bits sur FPGA.":
    ['VHDL', 'Quartus II'],
  "Lecture et affichage de la température par PIC 16F877 et LM35.":
    ['C', 'MicroC', 'Proteus'],
};
...
const interet = ['Automobile', 'Littérature', 'Voyages'];
...
const competences = {
  ...
  'Bus et protocoles de communication': ['CAN', 'UART'],
  ...
  'Compétences personnelles': ['Travail en équipe et initiative', 'Dynamique', 'Sérieux'],
};
